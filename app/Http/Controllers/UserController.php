...
class UserController extends Controller {
    ...
    public function showLoginForm() {
        ...
        return view('login_page '); // Return the login form view
    }
    ...
    public function home() {
        ...
        $announcements = Announcement::with(['event', 'event.donations'])
            ->whereHas('event', function ($query) {
                $query->where('event_status', 'Approved')->where('start_date', '<=', now())->where('end_date', '>=', now()) //not expire and approved
        ...
        return view('fundraise_home_page', compact('events', 'announcements', 'category'));
    }
