                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr>
                            <td>{{ $user->id }}</td>
                            <td>
                                <img src="{{ asset('storage/profile_photos/' . $user->user_photo) }}" alt="Profile Picture"
                                    class="img-thumbnail profile-picture" width="50">
                            </td>
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('admin.users.edit') }}" method="post"
                                            ...
                                            <div class="mb-3 text-center">
                                                <!-- Profile Photo Input -->
                                                <input type="file" id="editProfilePhoto{{ $user->id }}"
                                                    name="user_photo" class="d-none profile-photo-input"
                                                    data-preview-id="previewProfilePhoto{{ $user->id }}" />
                                                <!-- Profile Photo Preview with Tooltip -->
                                                <label for="editProfilePhoto{{ $user->id }}"
                                                    class="mb-0 clickable-label" data-toggle="tooltip"
                                                    data-placement="bottom" title="Click to change profile picture">
                                                    <img id="previewProfilePhoto{{ $user->id }}"
                                                        src="{{ asset('storage/profile_photos/' . $user->user_photo) }}"
                                                        alt="Profile Picture" class="img-thumbnail profile-picture"
                                                        width="100">
                                                </label>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="editContactNumber"
                                                    name="contact_number" value="{{ $user->contact_number }}" required>
                                            </div>
